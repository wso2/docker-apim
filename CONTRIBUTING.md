...
Unlike most projects, development for this repository is carried out on the `3.1.x` branch. This is because the `master` branch contains the latest stable release of the project.
The code in `3.1.x` is merged to the `master` branch after a final review and a round of testing.
