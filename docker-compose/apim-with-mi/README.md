...
3. Switch to `docker-compose/apim-with-mi` folder.
   ...
   > If you intend to try out an already released tag, after executing 2nd step, checkout the relevant tag, 
    i.e. for example: `git checkout tags/v4.1.0.1`, switch to `docker-compose/apim-with-mi` folder and continue with below steps.
...
4. Add deployable `CAR` files
   ...
   Those will be added to the Service Catalog in APIM through Micro Integrator. For more information, refer the [documentation](https://apim.docs.wso2.com/en/4.1.0/tutorials/integration-tutorials/service-catalog-tutorial/#exposing-an-integration-service-as-a-managed-api).
