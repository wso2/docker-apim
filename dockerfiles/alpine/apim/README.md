...
This section defines the step-by-step instructions to build an Alpine OpenJDK  Docker image for WSO2 API Manager 2.5.0.
...
- Download [WSO2 API Manager v2.5.0](http://wso2.com/api-management/try-it/)
