...
This section defines the step-by-step instructions to build a Linux [Alpine](https://hub.docker.com/_/alpine/) based Docker image for WSO2 API Manager Analytics 2.6.0.
...
- `docker run -it -p 9444:9444 wso2am-analytics:2.6.0-alpine`
