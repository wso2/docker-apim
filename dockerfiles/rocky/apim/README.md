...
> In here, <TARGET_CONFIGS> refers to /home/wso2carbon/wso2am-4.7.0-beta/repository/conf folder of the container.
...
```
docker buildx build --platform linux/amd64,linux/arm64 -t <DOCKER_USERNAME>/wso2am:4.7.0-rocky --push .
```
