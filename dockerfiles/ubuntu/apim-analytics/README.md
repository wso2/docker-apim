...
- Navigate to `<ANALYTICS_DOCKERFILE_HOME>` directory. <br>
  ...
  + `docker build --build-arg WSO2_SERVER_DIST_URL=<URL_OF_THE_HOSTED_LOCATION/FILENAME> JDK_URL=<URL_OF_THE_HOSTED_JDK_LOCATION/FILENAME> -t wso2am-analytics:2.2.0 .`
