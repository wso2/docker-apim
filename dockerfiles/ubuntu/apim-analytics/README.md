...
- Navigate to `<ANALYTICS_DOCKERFILE_HOME>` directory. <br>
  ...
  + `docker build --build-arg  JDK_URL=<URL_OF_THE_HOSTED_JDK_LOCATION/FILENAME> -t wso2am-analytics:2.2.0 .`
    - eg:- Hosted locally: docker build --build-arg JDK_URL=http://172.17.0.1:8000/jdk-8u261-linux-x64.tar.gz -t wso2am-analytics:2.2.0 . 
    - eg:- Hosted remotely: docker build --build-arg JDK_URL=http://172.17.0.1:8000/jdk-8u261-linux-x64.tar.gz -t wso2am-analytics:2.2.0 .
