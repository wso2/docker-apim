...
```
docker run -it -p 9443:9443 -p 8243:8243 wso2am:4.1.0
```
...
```
docker buildx build --platform linux/amd64,linux/arm64 -t <DOCKER_USERNAME>/wso2am:4.1.0-multiarch --push .
```
...
- To run on amd64
```
docker run -it -p 9443:9443 -p 8243:8243 wso2/wso2am:latest
```

- To run on native Apple Silicon ( arm64 )
```
docker run -it -p 9443:9443 -p 8243:8243 wso2/wso2am:4.1.0-multiarch
```
