...
```
docker build -t wso2am:4.5.0-jdk17 .
```
...
```
docker run -it -p 9443:9443 -p 8243:8243 wso2am:4.5.0-jdk17
```
...
The above wso2am:4.5.0-jdk17 image will only be supported for the CPU architecture of your current machine. Docker buildx plugin can be used to build wso2am:4.5.0-jdk17 image to support any CPU architecture.
...
```
docker buildx build --platform linux/amd64,linux/arm64 -t <DOCKER_USERNAME>/wso2am:4.5.0-jdk17 --push .
```
...
#### 5. Run
```
docker run -it -p 9443:9443 -p 8243:8243 <DOCKER_USERNAME>/wso2am:4.5.0-jdk17
```
...
- To run on amd64
```
docker run -it -p 9443:9443 -p 8243:8243 wso2/wso2am:4.5.0-jdk17
```
