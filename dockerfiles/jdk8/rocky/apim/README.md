...
This section defines the step-by-step instructions to build an [rocky](https://hub.docker.com/_/rocky/) Linux based Docker image for WSO2 API Manager 4.0.0.
...
- Navigate to `<AM_DOCKERFILE_HOME>` directory. <br>
  Execute `docker build` command as shown below.
    + `docker build -t wso2am:4.0.0-rocky-jdk8 .`
...
- `docker run -it -p 9443:9443 wso2am:4.0.0-rocky-jdk8`
